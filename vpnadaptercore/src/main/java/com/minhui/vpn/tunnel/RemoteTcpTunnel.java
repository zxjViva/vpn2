...
import com.minhui.vpn.hooker.TcpHooker;
...
public class RemoteTcpTunnel extends RawTcpTunnel {
    private final TcpHooker tcpHooker;
    String TAG = "RemoteTcpTunnel";
    ...
    protected ByteBuffer afterReceived(ByteBuffer buffer) throws Exception {
        Log.e(TAG, "afterReceived: ");
        buffer = tcpHooker.afterReceived(buffer);
